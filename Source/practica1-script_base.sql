...
ALTER TABLE empresa ALTER COLUMN activo BIT;
ALTER TABLE hotel ALTER COLUMN activo BIT;
ALTER TABLE habitacion ALTER COLUMN disponible BIT;
GO

-- b. Agregar una restricción de llave primaria a la columna 'id' de la tabla 'habitacion'
ALTER TABLE habitacion ALTER COLUMN id INT NOT NULL;
GO
ALTER TABLE habitacion ADD CONSTRAINT PK_habitacion PRIMARY KEY (id);
GO

-- c. Agregar las restricciones de llaves foráneas correspondientes en la tabla 'habitacion'
ALTER TABLE habitacion
ADD CONSTRAINT FK_habitacion_hotel FOREIGN KEY (id_hotel) REFERENCES hotel(id),
    CONSTRAINT FK_habitacion_tipo_habitacion FOREIGN KEY (id_tipo_habitacion) REFERENCES tipo_habitacion(id);
GO

-- d. Eliminar las columnas 'nombre_habitacion' y 'descripcion' de la tabla 'habitacion'
ALTER TABLE habitacion DROP COLUMN nombre_habitacion, descripcion;
GO
